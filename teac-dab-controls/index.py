...
button_cooldown_rate = int(config_data['button_cooldown_rate']['value'])
...
# start threads
t1 = threading.Thread(target=controls.controls, args=(controlQ, rot_enc_A, rot_enc_B, buttons_clk, buttons_miso, buttons_mosi, buttons_cs, buttons_channel1, buttons_channel2, spi_bus, spi, btn_config, btn_skip_config, button_poll_rate, button_debounce_rate, button_cooldown_rate))
